...
typedef struct OBJ_STRUCT_PACKED_START {
   ...
   INT16   i16AnaloginputCH1; /**< \brief (SI17) Analog input value*/
	 INT16   i16AnaloginputCH2; /**< \brief (SI17) Analog input value*/
} OBJ_STRUCT_PACKED_END
TOBJ6020;
...
///**
// * \brief 0x6010 (Analog input object) object and entry names
// */
 ...
 */
OBJCONST UCHAR OBJMEM aName0x6020[] = "AI Inputs\000Underrange\000Overrange\000Limit 1\000\000Limit 2\000\000\000\000\000\000\000\000\000\000TxPDO State\000TxPDO Toggle\000Analog CH1\000Analog CH2\000\377";
#endif //#ifdef _OBJD_
...
#ifdef _EVALBOARD_
= {18, 0x00, 0x00, 0x00, 0x00, 0, 0, 0x00, 0x00, 0x00, 0x00}
#endif
;
...
//	 /* Object 0x6010 */
//   {NULL,NULL,   0x6010, {DEFTYPE_INTEGER16, 0 | (OBJCODE_VAR << 8)}, &asEntryDesc0x6010, aName0x6010, &Var0x6010, NULL, NULL, 0x0000 },
   /* Object 0x6020 */
